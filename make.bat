...
rem Assemble/link TPK into flat binary file (not an EXE)
%ASM% -3 -Fl -Fo tpk.obj tpk.asm || exit /b 1
%LINK% format raw bin option quiet,map file tpk.obj name tpk.bin || exit /b 1
